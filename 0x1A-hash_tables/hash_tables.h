...
/**
 * struct shash_node_s a node within a sorted hash table.
 *
 * @key: The string key, which must be unique in the HashTable.
 ...
 * @array: An array of size @size, where each cell is a pointer to the first node
 *         of a linked list, as we employ Chaining collision handling in our HashTable.
